        ...
        {myData.map((item) => (
          <SwiperSlide className="swiper-slide h-full" key={item.id}>
            <div className="relative h-full w-full">
              ...
              <div onClick={() => navigate(`/estatedetails/${item.id}`)} className="absolute  w-4/5 md:w-2/4  mx-auto h-1/2 md:h-1/3  my-auto inset-0 flex flex-col bg-white/80 text-black rounded-md ">
